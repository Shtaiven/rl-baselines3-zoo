        ...
        for env in envs:
            for obstacle in obstacles:
                for reward_type in reward_types:
                    ...
                    subprocess.call(
                        f"python3 {source_dir}/train.py --env {env} --algo {algo} --tensorboard-log {source_dir}/autoruns/obstacles/{obstacle}/{reward_type} --save-freq 100000 --env-kwargs reward_type:{repr(reward_type)}".split()
                    )
