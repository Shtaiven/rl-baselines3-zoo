...
```sh
python train.py --algo ppo --env PandaReachJoints-v2 --tensorboard-log runs/stable-baselines/ --save-freq 100000
```

To view the trained policy, run:

```sh
python enjoy.py --env PandaReachJoints-v2 --algo ppo --exp-id 0 --env-kwargs render:True
```
